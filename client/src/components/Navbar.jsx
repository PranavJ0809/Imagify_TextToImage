      ...
      <div> 
        ...
        (
          <div className="flex items-center gap-2 sm:gap-3">
            <button onClick={() => navigate("/buy")} className="flex items-center gap-1 bg-blue-100 rounded-full px-4 sm:px-6 py-1.5 sm:py-3 shadow hover:scale-105 transition-all duration-700">
